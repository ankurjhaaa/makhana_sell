...
<body class="bg-secondary text-gray-800 pb-20 md:pb-0">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="{{ route('home') }}" class="text-gray-600 hover:text-primary font-medium transition-colors">Home</a>
                    <a href="{{ route('items') }}" class="text-gray-600 hover:text-primary font-medium transition-colors">Products</a>
                    <a href="{{ route('cart') }}" class="text-gray-600 hover:text-primary font-medium transition-colors">Cart</a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Premium quality handpicked fox nuts for your healthy lifestyle. Natural, organic, and delicious.</p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('items') }}" class="text-gray-500 hover:text-primary text-sm">All Products</a></li>
                        <li><a href="{{ route('cart') }}" class="text-gray-500 hover:text-primary text-sm">My Cart</a></li>
                    </ul>
                </div>
                <div>
    ...
    <div class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around items-center h-16 z-50">
        <a href="{{ route('home') }}" class="flex flex-col items-center {{ request()->routeIs('home') ? 'text-primary' : 'text-gray-400' }}">
            <i class="fas fa-home text-xl"></i>
            <span class="text-[10px] mt-1 font-medium">Home</span>
        </a>
        <a href="{{ route('items') }}" class="flex flex-col items-center {{ request()->routeIs('items') ? 'text-primary' : 'text-gray-400' }}">
            <i class="fas fa-search text-xl"></i>
            <span class="text-[10px] mt-1 font-medium">Browse</span>
        </a>
        <a href="{{ route('cart') }}" class="flex flex-col items-center {{ request()->routeIs('cart') ? 'text-primary' : 'text-gray-400' }}">
